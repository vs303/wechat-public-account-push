...
function  leapDays (y)  {     if  (leapMonth(y))  {       return  ((lunarInfo[y  -  1900]  &  0x10000)  ?  30  :  29)
...
function  monthDays (y,  m)  {     if  (m  >  12  ||  m  <  1)  {  return  -1  } // 月份参数从1至12，参数错误返回-1
...
function  toGanZhiYear (lYear)  {     var  ganKey  =   (lYear  -  3)  %  10
...
function  toAstro (cMonth,  cDay)  {     var  s  =  '\u9b54\u7faf\u6c34\u74f6\u53cc\u9c7c\u767d\u7f8a\u91d1\u725b\u53cc\u5b50\u5de8\u87f9\u72ee\u5b50\u5904\u5973\u5929\u79e4\u5929\u874e\u5c04\u624b\u9b54\u7faf'
...
function  solar2lunar (y,  m,  d)  {  // 参数区间1900.1.31~2100.12.31
    ...
    for  (i  =  1900;  i  <  2101  &&  offset  >  0;  i++)  {       temp  =  lYearDays(i)
    ...
    for  (i  =  1;  i  <  13  &&  offset  >  0;  i++)  {       // 闰月
        ...
        else  {         temp  =  monthDays(year,  i) // 计算农历普通月天数
...
let  calendarFormatter =   {       // 传入阳历年月日获得详细的公历、农历object信息 <=>JSON
    ...
    /**
        ...
        if  (isLeapMonth)  {           _day  =  leapDays(y,  m)
